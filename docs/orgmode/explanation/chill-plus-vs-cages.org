...
six-rings, and HC/DDC affiliation. OpenMP target offload
(~SEAMS_OFFLOAD~) is the same TUM ice score on the hop-bound
six-ring and affiliation predicates, plus Steinhardt. CHILL,
CHILL+, and \(q_{lm}\) stay on the host. Only cage labels come
back from the TUM device walk.
